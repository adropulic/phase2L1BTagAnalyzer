...
void runIso(){
  ...
  //TString inFile = "~/Dropbox/phase2-Apr11/dyll-nom.root";
  TString inFile = "/afs/cern.ch/work/s/skkwan/public/triggerDevel/feb2019/CMSSW_10_5_0_pre1/src/L1Trigger/phase2L1BTagAnalyzer/tau_exercise/files/dyll.root";
  TString outFile = "efficiency";
  TString denominatorCut = "recoPt>15&&abs(recoEta)<1.6";
