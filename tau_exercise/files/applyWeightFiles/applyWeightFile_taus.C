...
{   
   ...
   */
   ...
   /* Prepare input tree. */
   TString fname = TString("/afs/cern.ch/work/s/skkwan/public/triggerDevel/feb2019/CMSSW_10_5_0_pre1/src/L1Trigger/phase2L1BTagAnalyzer/tau_exercise/files/dyll-ext4.root");
   ...
   /* Write histograms */
   TFile *target  = new TFile( "appliedWeightFile_dyll-ext4.root", "RECREATE" );
   for (std::map<std::string,int>::iterator it = Use.begin(); it != Use.end(); it++)
